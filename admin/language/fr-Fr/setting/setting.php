...
$_['entry_stock_warning']            = 'Comment hors Stock Avertissement';
...
$_['help_limit_admin']               = 'Détermine combien d\'éléments d\'administration sont affichés par page (commandes, clients, etc.).';
$_['help_product_count']             = 'Affiche le nombre de produits dans les sous-catégories du menu de la catégorie d\'en-tête du magasin. Soyez averti, cela entraînera un coup de performance extrême pour les magasins avec beaucoup de sous-catégories!';
...
$_['help_customer_group_display']    = 'Afficher les groupes de clients que les nouveaux clients peuvent sélectionner, tels que le commerce de gros et l\'entreprise, lors de l\'inscription.';
$_['help_customer_price']            = 'Afficher uniquement les prix lorsqu\'un client est connecté.';
$_['help_login_attempts']            = 'Tentatives de connexion maximum autorisées avant que le compte ne soit verrouillé pendant 1 heure. Les comptes clients et affiliés peuvent être déverrouillés sur les pages d\'administration du client ou de l\'affilié';
$_['help_login_attempts']            = 'Tentatives de connexion maximum autorisées avant que le compte ne soit verrouillé pendant 1 heure. Les comptes clients et affiliés peuvent être déverrouillés sur les pages d\'administration des clients ou des affiliés. '
;
...
$_['help_stock_warning']             = 'Afficher le message de rupture de stock sur la page du panier si un produit est en rupture de stock mais que la commande en stock est oui. (L`\'avertissement indique toujours si la commande de stock est non
)';
...
$_['help_affiliate_auto']            = 'Ajouter automatiquement une commission lorsque chaque commande atteint l\'état complet.';
...
$_['help_return_status']             = 'Définir l\'état de retour par défaut lorsqu\'une demande de retour est soumise.';
...
$_['help_mail_parameter']            = 'En utilisant \'Mail\', des paramètres de messagerie supplémentaires peuvent être ajoutés ici(e.g. -f email@storeaddress.com).';
...
$_['help_mail_alert_email']          = 'Sélectionnez les fonctionnalités pour lesquelles vous souhaitez recevoir un e-mail d\'alerte lorsqu\'un client les utilise';
...
$_['error_login_attempts']           = 'LLes tentatives de connexion doivent être supérieures à 0!';
...
$_['error_log_required']             = 'Nom du fichier journal d\'erreur requis!';
$_['error_log_invalid']              = 'Le nom du fichier journal d\'erreur est incorrect!';
$_['error_log_extension']            = 'Error Log L\'extension du nom de fichier doit être .log!';
